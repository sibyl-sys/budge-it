...
class _AccountDetailsState extends State<AccountDetails> {
  ...
  renderTransactionListPerDay(
      User user, List<Transaction> transactions, Account currentAccount) {
    return Column(
            ...
            .map((transaction) => TransactionCard(
                  ...
                  icon: IconData(
                      transaction.transactionType != TransactionType.transfer
                          ...
                          : transaction.fromID == currentAccount.accountID
                              ? user.findAccountByID(transaction.toID)!.icon
                              : user.findAccountByID(transaction.fromID)!.icon,
                    ...
                    Row(children: [
                      currentAccount.creditLimit == 0
                          ? CircleAvatar(
                              ...
                              child: Icon(
                                  IconData(currentAccount.icon,
                                      fontFamily: 'MaterialIcons'),
                                  color: Color(currentAccount.color)
                                      .withOpacity(1),
                                  size: 24),
                            )
                          : CircularPercentIndicator(
                              ...
                              lineWidth: 4.0,
                              percent: user
                                  .getAccountProgress(currentAccount.accountID),
                              progressColor: Colors.lightGreen,
                              backgroundColor: currentAccount.creditLimit == 0
          ...
          Expanded(
            child: ListView(
              children: [
                        ...
                        child: OutlinedButton(
                          onPressed: () {
                            ...
                            user.selectRecipient(
                                user.incomeCategories[0].categoryID,
                      ...
                      Container(
                        ...
                        child: OutlinedButton(
                          onPressed: () {
                            ...
                            user.selectAccountFrom(currentAccount.accountID);
                            user.selectRecipient(
                                user.expenseCategories[0].categoryID,
                ...
                TotalHeader(
                  header: "Balance:",
                  valueColor: Color(0x55C9C6).withOpacity(1),
                        ...
                        .map((e) => Column(
                              children: [
                                ...
                                Padding(
                                    ...
                                    child: renderTransactionListPerDay(user,
                                        e["transactions"], currentAccount))
                              ],
                            ))
                        .toList())
              ],
