...
class IconSelection extends StatefulWidget {
  ...
  const IconSelection({Key? key, required this.iconData, required this.onIconChange}) : super(key: key);
            ...
            children: accountIconList["Accounts"]!.map((item) => OutlinedButton(
                ...
                style: OutlinedButton.styleFrom(
                  ...
                  side: BorderSide(
                      ...
                      color: widget.iconData == item ? Theme.of(context).primaryColor : Colors.grey.shade400
                  ),
                ),
                child: Icon(item)
              )
