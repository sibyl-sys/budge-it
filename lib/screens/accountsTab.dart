...
class AccountsTab extends StatefulWidget {
  ...
  const AccountsTab({Key? key, required this.onAccountTapped})
      : super(key: key);
  ...
  Widget renderCallToAction() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Image(
              image: AssetImage("assets/no_wallet.png"),
              height: 150,
              width: 150,
          ...
          Padding(
            ...
            child: Text("Ooops! You don't have a wallet yet",
        ...
        Expanded(
          child: Padding(
            ...
            child: ListView(
              ...
              children: [
                stash.length > 0
                    ? renderStashAccounts(user)
                    : SizedBox(height: 0),
                savings.length > 0
                    ? renderSavingsAccounts(user)
                    : SizedBox(height: 0)
              ],
            ),
          ),
