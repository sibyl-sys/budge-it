                          ...
                          children: [
                            ...
                            RichText(
                              text: TextSpan(
                                  ...
                                  children: [
                                    TextSpan(
                                        text: "${moneyFormat.format(user.getCategoryTypeNet(from: this.from, to: this.to, categoryType: CategoryType.expense).abs()).split('.')[0]}",
                                        style: TextStyle(
                                            color: Color(0xffEB6467),
                                            fontSize: 14,
                                            fontFamily: "Poppins",
                                    ...
                                    TextSpan(
                                        text: ".${moneyFormat.format(user.getCategoryTypeNet(from: this.from, to: this.to, categoryType: CategoryType.expense).abs()).split('.')[1]}",
                                        style: TextStyle(
                                            color: Color(0xffEB6467),
                                            fontSize: 12,
                                            fontFamily: "Poppins",
                          ...
                          children: [
                            ...
                            RichText(
                              text: TextSpan(
                                  ...
                                  children: [
                                    TextSpan(
                                        text: "${moneyFormat.format(user.getCategoryTypeNet(from: this.from, to: this.to, categoryType: CategoryType.income).abs()).split('.')[0]}",
                                        style: TextStyle(
                                            color: Color(0xff55C9C6),
                                            fontSize: 14,
                                            fontFamily: "Poppins",
                                    ...
                                    TextSpan(
                                        text: ".${moneyFormat.format(user.getCategoryTypeNet(from: this.from, to: this.to, categoryType: CategoryType.income).abs()).split('.')[1]}",
                                        style: TextStyle(
                                            color: Color(0xff55C9C6),
                                            fontSize: 12,
                                            fontFamily: "Poppins",
