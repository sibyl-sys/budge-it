              ...
              child: Row(
                ...
                children: [
                  DateButton(
                    ...
                    header: "This Year",
                    subtitle: "None",
                    isActive: !(compareDates(
                            widget.fromDate, DateTime(now.year, 1, 1)) &&
                        compareDates(
                            widget.toDate, DateTime(now.year + 1, 1, 0))),
                    onTap: () {
                  ...
                  DateButton(
                    ...
                    header: "This Month",
                    subtitle: "None",
                    isActive: !(compareDates(widget.fromDate,
                            DateTime(now.year, now.month, 1)) &&
                        compareDates(widget.toDate,
                      ...
                      child: Ink(
                        ...
                        child: InkWell(
                          onTap: () async {
                            ...
                            if (results != null) {
                              Navigator.of(context).pop(
                                  {"from": results.start, "to": results.end});
                            }
                          },
                          splashColor:
              ...
              child: Row(
                ...
                children: [
                  DateButton(
                    ...
                    isActive: !(compareDates(widget.fromDate, yesterday) &&
                        compareDates(widget.toDate, yesterday)),
                    onTap: () {
                      Navigator.of(context)
                          .pop({"from": yesterday, "to": yesterday});
                    },
                  ),
                  SizedBox(width: 16.0),
                  DateButton(
                    ...
                    isActive: !(compareDates(widget.fromDate, now) &&
                        compareDates(widget.toDate, now)),
                    onTap: () {
                      Navigator.of(context).pop({"from": now, "to": now});
                    },
                  ),
                ],
              ),
