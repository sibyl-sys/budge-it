...
class _CategoryPercentBarState extends State<CategoryPercentBar> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Category> categories = widget.categoryType == CategoryType.expense
        ? user.expenseCategories
        : user.incomeCategories;
    double limit = user.getCategoryTypeNet(
        from: widget.from, to: widget.to, categoryType: widget.categoryType);
    return Padding(
